...
Maintainers may use generative AI tools as assistants while working on gs-plugin-vanilla-meta. Non-trivial assisted commits disclose the tool, model, and scope of the work.
